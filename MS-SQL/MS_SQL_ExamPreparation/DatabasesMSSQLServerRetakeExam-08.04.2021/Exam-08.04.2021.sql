...
DECLARE @EmployeeDepartmentId INT = (SELECT DepartmentId FROM Employees									
									WHERE Id = @EmployeeId)
DECLARE @ReportCategoryDepartmentId INT = (SELECT d.Id FROM Reports AS r
									JOIN Categories AS c ON r.CategoryId = c.Id
