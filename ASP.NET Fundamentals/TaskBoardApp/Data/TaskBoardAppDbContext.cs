...
namespace TaskBoardApp.Data
{
    ...
    {
        public TaskBoardAppDbContext(DbContextOptions<TaskBoardAppDbContext> options): base(options)
        {
        ...
        private void SeedUsers()
        {
            ...
            GuestUser.PasswordHash = passwordHasher.HashPassword(GuestUser, "guest");
        }
